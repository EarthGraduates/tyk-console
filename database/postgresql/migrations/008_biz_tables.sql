...
-- ============================================================
-- 表 1：sample_types — 样本类型字典
-- ============================================================
CREATE TABLE biz.sample_types (
  ...
  CONSTRAINT uq_sample_types UNIQUE (lab_org, sample_type)
);

COMMENT ON TABLE biz.sample_types IS '样本类型字典，医院上传/下载的样本类型对照数据';
...
-- 种子数据：样本类型
-- ============================================================
INSERT INTO biz.sample_types (lab_org, sample_type, sample_describe, srm1, srm2) VALUES
  ('ORG001', '01', '血液', 'XY', 'AB'),
  ('ORG001', '02', '尿液', 'NY', 'NS')
...
VALUES
  ('NX-MD-O001', 'NX', 'A.主数据同步（字典对照）', 'MD', 'A07',
   '检验样本类型下载', 'nx_md_get_sample_type', '送检方', 'O', 'POST',
