...
export default function SecondReviewListPage() {
  const [data, setData] = useState<any[]>([]);
  const [loading, setLoading] = useState(true);
  const navigate = useNavigate();

  useEffect(() => {
    labReportDb.getPendingReviews({ reviewStage: 'second' })
      ...
      <Card title="待二审报告">
        ...
        <Table
          ...
          columns={[
            ...
            { title: '一审者', dataIndex: 'checkerName', width: 100 },
          ...
          onRow={record => ({
            onClick: () => navigate(`/business/lab/reviews/second-review/${record.reportId}`),
