...
TEMPLATES = {
    "NX-MD-O001": ("MD upload sample_types", lambda: md_upload("sample_type", "sample_describe")),
    "NX-MD-O002": ("MD upload request_items", lambda: md_upload("item_code", "item_name")),
    "NX-MD-O003": ("MD upload test_items", lambda: md_upload("item_code", "item_name")),
    "NX-MD-O004": ("MD upload bio_items", lambda: md_upload("item_code", "item_name")),
    "NX-MD-O005": ("MD upload anti_items", lambda: md_upload("item_code", "item_name")),
    "NX-MD-I001": ("MD download sample_types", md_download),
    "NX-MD-I002": ("MD download request_items", md_download),
    "NX-MD-I003": ("MD download test_items", md_download),
    "NX-MD-I004": ("MD download bio_items", md_download),
    "NX-MD-I005": ("MD download anti_items", md_download),
    "NX-SP-I001": ("SP specimen external", specimen_upload),
    "NX-RC-O001": ("RC get by barcode", specimen_query),
    "NX-RC-O002": ("RC receive specimen", specimen_receive),
    "NX-RC-I001": ("RC receive status", specimen_query),
    "NX-RC-I002": ("RC unqualified", specimen_query),
    "NX-RP-O001": ("RP submit report", report_upload),
    "NX-RP-O002": ("RP upload image", image_upload),
    "NX-RP-O003": ("RP cancel check", cancel_report),
    "NX-RP-I001": ("RP get report", report_query),
    "NX-RP-I002": ("RP get image", image_query),
    "NX-RP-I003": ("RP update flag", report_flag),
    "NX-RP-I004": ("RP get canceled", report_query),
    "NX-CV-O001": ("CV upload warn", warn_upload),
    "NX-CV-O002": ("CV get feedback", warn_query),
    "NX-CV-I001": ("CV get warn", warn_query),
    "NX-CV-I002": ("CV update feedback", warn_update),
    "NX-QC-I001": ("QC upload (hospital)", qc_upload),
    "NX-QC-O001": ("QC upload (center)", qc_upload),
    "NX-QC-O002": ("QC query", qc_query),
    "NX-QC-O003": ("QC stats", qc_query),
    "NX-QC-O004": ("QC eqa", qc_query),
    "NX-EQ-I001": ("EQ upload (hospital)", device_upload),
    "NX-EQ-O001": ("EQ upload (center)", device_upload),
    "NX-EQ-O002": ("EQ query", device_query),
    "NX-QR-I001": ("QR app list", app_query),
    "NX-QR-I002": ("QR submit app", app_submit),
}
...
async def main():
    ...
    # Data counts
    print("\n=== PG data summary ===")
    for tbl in ["sample_types","request_items","test_items","bio_items","anti_items",
                "specimens","test_reports","report_images","sample_warnings",
                "qc_data","device_info","applications"]:
